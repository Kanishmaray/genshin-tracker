...
export default function CharacterPage() {
  ...
  function debounceNotes(charId, field, value) {
    updateNotes(charId, field, value)
  }
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              <div className="flex items-center gap-2 mb-2 flex-wrap">
                ...
                <span className="text-xs px-2 py-0.5 rounded-full text-gray-400" style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.08)' }}>
                  {char.weapon}
                </span>
                <span
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
            ...
            <Section title="PLANS & NOTES" color={colors.secondary} defaultOpen={true}>
              <textarea
                ...
                onChange={e => debounceNotes(id, 'plans', e.target.value)}
              />
            </Section>
            ...
            <Section title="ARTIFACTS" color={colors.primary}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {pieces.map(p => (
                  ...
                  >
                    <button
                      onClick={() => updateChecklist(id, p.key, !cl[p.key])}
                ...
                {char.statGoals.map((goal, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-center gap-3">
                      <button
                        onClick={() => updateChecklist(id, key, !cl[key])}
            ...
            <Section title="TALENTS" color={colors.primary}>
              <div className="flex flex-col sm:flex-row gap-3 mb-3">
                {[
                  ...
                  <button
                    key={t.key}
                    onClick={() => updateChecklist(id, t.key, !cl[t.key])}
            ...
            <Section title="ARTIFACT SET" color={colors.primary}>
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 mt-2">
                  <div className="rounded-lg p-2 bg-white/5 border border-white/08">
                    <div className="text-xs text-gray-500 mb-1">Sands</div>
                    <div className="text-sm text-gray-200">{char.artifact.sands}</div>
                  </div>
                  <div className="rounded-lg p-2 bg-white/5 border border-white/08">
                    <div className="text-xs text-gray-500 mb-1">Goblet</div>
                    <div className="text-sm text-gray-200">{char.artifact.goblet}</div>
                  </div>
                  <div className="rounded-lg p-2 bg-white/5 border border-white/08">
                    <div className="text-xs text-gray-500 mb-1">Circlet</div>
                    <div className="text-sm text-gray-200">{char.artifact.circlet}</div>
                  </div>
                </div>
              </div>
            </Section>

            {/* Stat Goals Reference */}
                ...
                <div className="space-y-2">
                  {constellations.map((c, i) => {
                    ...
                    return (
                      ...
                      >
                        <span className="text-xs font-bold flex-shrink-0 w-7 text-center py-0.5 rounded" style={{ background: `${colors.primary}22`, color: colors.primary }}>
                          {c.level}
                        </span>
                        ...
                        {c.priority && (
                          <span className="text-xs px-1.5 py-0.5 rounded flex-shrink-0" style={{ background: `${priorityBadgeColor}18`, color: priorityBadgeColor, border: `1px solid ${priorityBadgeColor}33` }}>
                            {c.priority}
                          </span>
                        )}
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
            <GlowCard color={colors.primary} className="p-4">
              ...
              <textarea
                ...
                onChange={e => debounceNotes(id, 'general', e.target.value)}
              />
            </GlowCard>
